...
const Blackjack = () => {
  ...
  const [text, settext] = useState(
    "Enter a minimum of 10$ to start your game."
  );
  ...
  const findTotal = () => {
    settotalU(
      cardsValue[random[0]] +
        cardsValue[random[1]] +
        (random[2] ? cardsValue[random[2]] : 0) +
        (random[3] ? cardsValue[random[3]] : 0) +
        (random[4] ? cardsValue[random[4]] : 0)
    );
    settotalC(
      cardsValue[random[5]] +
        cardsValue[random[6]] +
        (random[7] ? cardsValue[random[7]] : 0) +
        (random[8] ? cardsValue[random[8]] : 0) +
        (random[9] ? cardsValue[random[9]] : 0)
    );
    if (
      cardsValue[random[0]] +
        cardsValue[random[1]] +
              ...
              <div className="row mt-5">
                <div className="col-md-6 text-center">
                  <div className="bj-user-hand">
                    ...
                    <h4 className="text-center mt-4 d-flex flex-colume justify-content-center">
                      Total {totalU}
                    </h4>
                  </div>
                </div>
                <div className="col-md-6 text-center">
                  <div className="bj-comp-hand">
                    ...
                    <h4 className="text-center mt-4 d-flex flex-row justify-content-center">
                      Total {count}
                    </h4>
                  </div>
                </div>
